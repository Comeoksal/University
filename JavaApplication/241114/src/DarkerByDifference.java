...
public class DarkerByDifference{
    ...
    public DarkerByDifference(String U_InputFile_Path, String U_OutputFile_Path){
        ...
        for(column = 0; column<=height-1; column++){
            for(row = 0; row<=width-1; row++){
                ...
                if(gray2==gray1){
                    ...
                    _darkValue = Math.abs(gray1-gray2);
                }
                int b_red = (red-_darkValue>255)? 255 : ((red-_darkValue<0) ? 0 : red - _darkValue);
                int b_green = (green-_darkValue>255)? 255 : ((green-_darkValue<0) ? 0 : green - _darkValue);
                int b_blue = (blue-_darkValue>255)? 255 : ((blue-_darkValue<0) ? 0 : blue -_darkValue);
